/*2. Leia 2 (dois) números, calcule e escreva o mmc (mínimo múltiplo comum) 
...
//Saída
     mensagem = (`
   ============================================
            O MMC de ${numero1} e ${numero2} é ${fazer_mmc(numero1,numero2)}
   ============================================
   `)
...
//Processamento
function fazer_mmc(numero1,numero2){
    return (numero1 * numero2)/fazer_mdc(numero1,numero2)
