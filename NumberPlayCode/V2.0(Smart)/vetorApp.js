import {getNumberInRange, ask, coloredPrint, aksLetter} from "./Funções/utils.js";
...
function main(){
    ...
    while (option !== 16){
        ...
        if (option === 1){
            ...
            vectorFunctions.saveVector(vector, "manual");
        }
    ...
    if (vector.length > 0 && aksLetter("Salvar?(S/N): ").toUpperCase() === "S"){
        vectorFunctions.saveVector(vector, "automatic");
    }
