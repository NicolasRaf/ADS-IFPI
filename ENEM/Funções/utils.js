...
/**
 * Show a mensage for user and recive any text
 * @param {*} text String
 * @returns The string write by the user
 */
...
/**
 * Show a mensage for user and recive one letter only.
 * @param {*} text String
 * @returns One letter upper or lowwer.
 */
...
/**
 * Show a message and get a number from user.
 * @param {*} text String
